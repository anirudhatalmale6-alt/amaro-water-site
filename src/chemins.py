...
Sans cette fonction, un `python3 page_amaro.py` lance depuis `src/` ecrit
ses pages dans `src/demo/`, un dossier que personne ne sert : le script dit
« ecrit », le site reste celui d'avant, et rien ne signale l'ecart.
"""
